...
const HeroSection: React.FC = () => {
    ...
    transition-transform duration-300 cursor-pointer"
                ...
                <div className="relative isolate">
                    ...
                    <div className="bg-white/5 backdrop-blur-2xl rounded-2xl py-8 px-6 shadow-2xl space-y-6 border border-white/10 hover:border-[#76b900]/30 transition-all duration-300 max-w-[700px] flex flex-col items-center justify-center">
                        <div className="text-4xl font-extrabold bg-gradient-to-r from-accent-accent1 to-accent-accent2 bg-clip-text text-transparent text-center w-full">
                            AKASH KUMAR
                        </div>
